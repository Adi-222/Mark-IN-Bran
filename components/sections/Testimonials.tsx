...
export default function Testimonials() {
  const testimonials = [
    {
      quote: <>Mark In <span className="text-blue-500">Bran</span> didn&apos;t just build a site; they built a digital home for our roasting philosophy. Our online sales doubled within a month of launch.</>,
