      ...
      <ScrollReveal>
        <div className="relative bg-primary-container dark:bg-primary-container rounded-[2rem] p-12 md:p-24 overflow-hidden text-center text-on-primary-container shadow-2xl">
          ...
          <div className="max-w-2xl mx-auto space-y-8 relative z-10">
            <h2 className="text-4xl md:text-6xl font-serif font-medium leading-tight text-white shadow-sm">Ready to build something people remember?</h2>
            <p className="text-lg opacity-90 text-white drop-shadow-sm">Let's build a brand your customers won't forget.</p>
            <div className="pt-4">
              <motion.button 
