...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="absolute right-16 px-3 py-1.5 bg-surface-container-highest dark:bg-white text-on-surface dark:text-black text-sm font-semibold rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap shadow-md">
        Chat with us
      </span>
    </a>
  )
